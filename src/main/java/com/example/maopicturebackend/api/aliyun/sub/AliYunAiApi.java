package com.example.maopicturebackend.api.aliyun.sub;
...
public class AliYunAiApi {
     ...
     * @return
     */
    public CreateOutPaintingTaskResponse createOutPaintingTask(CreateOutPaintingTaskDTO createOutPaintingTaskRequest) {
